        ...
        <div>
            <div className="overflow-x-auto">
                <table className="min-w-full">
                        ...
                        <tr>
                            ...
                            <th className="px-4 py-3 text-left text-sm font-medium ">
                                <div className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-gray-200 inline mr-2" viewBox="0 0 512 512">
                                        <path
                            ...
                            <th className="px-4 py-3 text-left text-sm font-medium ">
                                <div className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-gray-200 inline mr-2" fill-rule="evenodd" viewBox="0 0 24 24">
                            ...
                            <th className="px-4 py-3 text-left text-sm font-medium ">
                                <div className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-gray-200 inline mr-2" viewBox="0 0 24 24">
                    ...
                    <tbody className="whitespace-nowrap divide-y divide-gray-500">
                        {
