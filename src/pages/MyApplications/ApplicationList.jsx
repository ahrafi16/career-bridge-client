        ...
        <div>
            <div class="overflow-x-auto">
                <table class="min-w-full">
                        ...
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-sm font-medium ">
                                <div class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-gray-200 inline mr-2" viewBox="0 0 512 512">
                                        <path
                            ...
                            <th class="px-4 py-3 text-left text-sm font-medium ">
                                <div class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-gray-200 inline mr-2" fill-rule="evenodd" viewBox="0 0 24 24">
                            ...
                            <th class="px-4 py-3 text-left text-sm font-medium ">
                                <div class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-gray-200 inline mr-2" viewBox="0 0 24 24">
                    ...
                    <tbody class="whitespace-nowrap divide-y divide-gray-500">
                        {
